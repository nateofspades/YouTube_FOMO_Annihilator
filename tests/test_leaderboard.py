...
class LeaderboardTests(unittest.TestCase):
    ...
    def test_single_leaderboard_page_offers_category_and_date_filters_without_biotech(self):
        ...
        self.assertIn('<input id="date" name="date" type="date" disabled>', content)
        ...
        self.assertIn("dateSelect.min=dates.at(-1).date", content)
        self.assertIn("dateSelect.max=dates[0].date", content)
